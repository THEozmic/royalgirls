...
<div class="wrapper">
 <?php $pagename = "Teachers"; $subpagename = "Register Teacher"; $subsubpage = null; $pageicon = "fa fa-magic"; $subpageicon = "fa fa-circle-o";?>

  <?php require_once "../inc/header.inc"; ?>
  <?php require_once "../inc/side-bar.php"; $user_type = $_SESSION["user_type"];?>
  ...
  <div class="content-wrapper">
      ...
      <?php require_once "../inc/admitteacher-content.php"; ?>
